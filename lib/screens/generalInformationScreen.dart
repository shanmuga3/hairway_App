...
class GeneralInformationScreen extends BaseRoute {
  ...
  GeneralInformationScreen(this.email, this.password, {a, o}) : super(a: a, o: o, r: 'GeneralInformationScreen');
  @override
  _GeneralInformationScreenState createState() => new _GeneralInformationScreenState(this.email, this.password);
}
...
class _GeneralInformationScreenState extends BaseRouteState {
                    ...
                    child: Container(
                        ...
                        child: Column(children: [
                          Container(
                              ...
                              child: Text(
                                AppLocalizations.of(context).lbl_generall_information,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        AppLocalizations.of(context).lbl_saloon_type,
                                        style: Theme.of(context).primaryTextTheme.subtitle2,
                                      ),
                                    ),
                                    Padding(
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              Text(AppLocalizations.of(context).lbl_male)
                                            ],
                                          ),
                                          Row(
                                            children: [
                                              ...
                                              Text(AppLocalizations.of(context).lbl_female)
                                            ],
                                          ),
                                          Row(
                                            children: [
                                              ...
                                              Text(AppLocalizations.of(context).lbl_unisex)
                                            ],
                                          ),
                                        ],
                                      ),
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Stack(alignment: AlignmentDirectional.bottomEnd, children: [
                                            CircleAvatar(
                                              radius: 50,
                                              backgroundImage: _tImage != null ? FileImage(_tImage) : AssetImage('assets/userImage.png'),
                                            ),
                                            GestureDetector(
                                              onTap: () {
                                                FocusScope.of(context).unfocus();
                                    ...
                                    Container(
                                      ...
                                      child: TextButton(
                                        ...
                                        child: Text(AppLocalizations.of(context).btn_create_account),
                                      ),
                                    ),
                                    Container(
                                      margin: EdgeInsets.only(top: 25),
  ...
  signUp() async {
    try {
      ...
      if (_cVenderName.text.isNotEmpty && _cPhoneNumber.text.isNotEmpty && _cPhoneNumber.text.length == 10 && _cOwnerName.text.isNotEmpty && _cAddress.text.isNotEmpty && _cDescription.text.isNotEmpty && _cemployeeID.text.isNotEmpty  && _tImage != null) {
        ...
        showSnackBar(key: _scaffoldKey, snackBarMessage: AppLocalizations.of(context).txt_please_enter_owner_name);
      ...
      print("Exception - generalInformationScreen.dart - _signUp():" + e.toString());
    }
  }
  ...
  _showCupertinoModalSheet() {
    try {
      ...
      print("Exception - generalInformationScreen.dart - _showCupertinoModalSheet():" + e.toString());
    }
  }
}
