...
class CurrentUser {
  ...
  Map<String, dynamic> toJson() => {
        ...
        'employee_id':
            employee_id != null && employee_id.isNotEmpty ? employee_id : null,
  ...
  CurrentUser.fromJson(Map<String, dynamic> json) {
    try {
      ...
      wallet_credits =
          json['wallet_credits'] != null ? json['wallet_credits'] : null;
      ...
      phone_verified =
          json['phone_verified'] != null && json['phone_verified'] == 1
              ...
              : false;
      referral_code =
          json['referral_code'] != null ? json['referral_code'] : null;
      remember_token =
          json['remember_token'] != null ? json['remember_token'] : null;

      vendor_password =
          json['vendor_password'] != null ? json['vendor_password'] : null;
      vendor_address = json['vendor_loc'] != null ? json['vendor_loc'] : null;
      description = json['description'] != null ? json['description'] : null;
      employee_id = json['employee_id'] != null ? json['employee_id'] : null;
      ...
      weekly_time = (json['weekly_time'] != null)
          ? List<VendorTiming>.from(
              json['weekly_time'].map((e) => VendorTiming.fromJson(e)))
          : [];
