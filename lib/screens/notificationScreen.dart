...
class _NotificationScreenState extends BaseRouteState {
                            ...
                            ? _notificationList.length > 0
                                    ...
                                    child: ListView.builder(
                                        ...
                                        itemBuilder: (BuildContext context, int index) {
                                          return Container(
                                            ...
                                            child: Card(
                                                shape: RoundedRectangleBorder(borderRadius: global.isRTL ? BorderRadius.only(topRight: Radius.circular(20), bottomRight: Radius.circular(20)) : BorderRadius.only(topLeft: Radius.circular(20), bottomLeft: Radius.circular(20))),
                                                child: ExpansionTile(
                                                  leading: Container(
                                                    padding: EdgeInsets.only(top: 3, bottom: 3),
                                                    margin: global.isRTL ? EdgeInsets.only(right: 0) : EdgeInsets.only(left: 0),
                                                    child: CircleAvatar(
                                                      child: _notificationList[index].image == null || _notificationList[index].image == 'https://thecodecafe.in/gofreshaN/A'
                                                          ? CircleAvatar(
                                                              radius: 28,
                                                          ...
                                                          : CachedNetworkImage(
                                                              imageUrl: global.baseUrlForImage + _notificationList[index].image,
                                ...
                                : Center(
                                    child: Padding(
                                      ...
                                      child: Text(AppLocalizations.of(context).txt_notification_will_shown_here),
                                    ),
                                  )
                            : _shimmer()
                      ],
  ...
  getNotification() async {
    try {
      ...
      print("Exception - notificationScreen.dart - _getNotification():" + e.toString());
    }
  }
