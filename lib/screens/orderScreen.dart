...
class _OrderScreenState extends BaseRouteState {
                      ...
                      children: [
                        ...
                        _isDataLoaded
                            ? _orderList.length > 0
                                          ...
                                          return Container(
                                            ...
                                            child: Card(
                                              ...
                                              children: [
                                                Expanded(
                                                  child: Container(
                                                      padding: global.isRTL ? EdgeInsets.only(top: 5, right: 5) : EdgeInsets.only(top: 5, left: 5),
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              _orderList[index].user != null ? '${_orderList[index].order_cart_id}-${_orderList[index].user.name}' : '${_orderList[index].order_cart_id}-No name',
                                                              style: TextStyle(fontSize: 14, color: Colors.black),
                                                              overflow: TextOverflow.ellipsis,
                                                              maxLines: 1,
                                                            ),
                                                          ),
                                                          _orderList[index].user != null
                                                              ? Padding(
                                                                  padding: EdgeInsets.only(),
                                                                  child: Text(
                                                                    _orderList[index].user != null ? '${_orderList[index].user.user_phone}' : '',
                                                          ...
                                                          Row(
                                                            children: [
                                                              Container(
                                                                height: 60,
                                                                width: 60,
                                                                child: _orderList[index].productImage == ""
                                                                    ? ClipRRect(
                                                                    ...
                                                                    : ClipRRect(
                                                                        ...
                                                                        child: CachedNetworkImage(
                                                                          imageUrl: global.baseUrlForImage + _orderList[index].productImage,
                                                              ...
                                                              Expanded(
                                                                child: Container(
                                                                  margin: global.isRTL ? EdgeInsets.only(right: 5) : EdgeInsets.only(left: 5),
                                                                  child: Column(
                                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                                    children: [
                                                                      Padding(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        GestureDetector(
                                                          onTap: () {
                                                            if (_orderList[index].statustext == "Pending") {
                                                              _orderConfirmationDialog(_orderList[index].store_order_id);
                                                            }
                                                          },
                                                          child: Container(
                                                            height: 30,
                                                        ...
                                                        Padding(
                                                          padding: global.isRTL ? EdgeInsets.only(top: 3, left: 5) : EdgeInsets.only(top: 3, right: 5),
                                                          child: Text(
                                                        ...
                                                        Padding(
                                                          padding: global.isRTL ? EdgeInsets.only(top: 2, bottom: 2, left: 5) : EdgeInsets.only(top: 2, bottom: 2, right: 5),
                                                          child: Row(
                                ...
                                : Container(padding: EdgeInsets.only(top: MediaQuery.of(context).size.height / 3), child: Text(AppLocalizations.of(context).txt_orders_will_shown_here))
  ...
  Future _orderConfirmationDialog(storeOrderId) async {
    try {
      ...
      print("Exception - orderScreen.dart - _orderConfirmationDialog():" + e.toString());
    }
  }
